...
class Crawler:
  ...
  def init_spider(self):
    ...
    if self.type == "website":
      self.spider = CrawlerProcess(settings=spider_default_setting)
      self.spider.crawl(DomainCrawler, user_settings=self.settings)
...
def main():
  url = "https://ngoainguquocgia.moet.gov.vn/ky-ket-bien-ban-ghi-nho-thuc-day-quan-he-hop-tac-ve-dao-tao-ngoai-ngu-1709905.html"
